...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "Noticias",},{id: "news-um-anúncio-longo-com-detalhes",
        ...
        handler: () => {
          window.open("/assets/pdf/es-es//assets/pdf/[LANG]/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
      ...
      id: 'light-theme',
      title: 'Cambiar al modo claro',
      description: 'Cambiar el tema del sitio a modo claro',
      section: 'Tema',
      handler: () => {
    ...
    {
      id: 'dark-theme',
      title: 'Cambiar al modo oscuro',
      description: 'Cambiar el tema del sitio a modo oscuro',
      section: 'Tema',
      handler: () => {
    ...
    },
    {
      ...
      description: 'Cambiar el tema del sitio a la configuración del sistema',
      section: 'Tema',
      handler: () => {
