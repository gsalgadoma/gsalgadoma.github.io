...
title: "CV"
permalink: /cv/
excerpt: "Trayectoria profesional y académica en fonoaudiología, epidemiología, docencia universitaria, investigación y liderazgo en salud."
author_profile: true
redirect_from:
  - /resume
---
...
<style>
.cv-profile { font-size: 0.92rem; line-height: 1.7; color: var(--global-text-color); }
.cv-profile h2 { font-size: 0.95rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; border-bottom: 2px solid var(--global-border-color); padding-bottom: 0.35rem; margin-top: 2rem; margin-bottom: 1rem; }
.cv-lead { font-size: 1.05rem; line-height: 1.65; margin-bottom: 1.2rem; }
.cv-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(210px, 1fr)); gap: 0.9rem; margin: 1rem 0 1.3rem; }
.cv-card { border: 1px solid var(--global-border-color); border-radius: 6px; padding: 1rem; background: var(--global-bg-color); }
.cv-card h3 { font-size: 1rem; margin: 0 0 0.35rem; }
.cv-card p { margin: 0; font-size: 0.86rem; }
.cv-entry { border-left: 3px solid #2a5db0; padding: 0.25rem 0 0.25rem 0.9rem; margin-bottom: 1rem; }
.cv-entry p { margin: 0.15rem 0; }
.cv-entry .date { font-size: 0.8rem; opacity: 0.8; }
.cv-button { display: inline-block; background: #2a5db0; color: #fff !important; padding: 7px 14px; border-radius: 4px; font-size: 0.84rem; font-weight: 600; text-decoration: none !important; margin: 0.25rem 0.4rem 0.25rem 0; }
.cv-dynamic h2 { margin-top: 2.2rem; }
</style>
...
<div class="cv-grid">
  <div class="cv-card">
    ...
    <p>Deglución, comunicación, voz, vía aérea, neurología y rehabilitación en contextos hospitalarios y de alta complejidad.</p>
  </div>
  <div class="cv-card">
    <h3>Perfil académico</h3>
    <p>Docencia de pregrado, posgrado y educación continua en fonoaudiología, epidemiología, bioestadística y salud pública.</p>
  </div>
  <div class="cv-card">
    <h3>Investigación y gestión</h3>
    <p>Epidemiología aplicada, síntesis de evidencia, resultados en salud, formación de profesionales y articulación con organizaciones científicas.</p>
  </div>
</div>
...
<div class="cv-entry">
  <p><strong>Licenciado en Fonoaudiología</strong> · Universidad del Desarrollo</p>
  <p class="date">2008</p>
</div>
...
<div class="cv-entry">
  ...
  <p>Docencia de pregrado en evaluación e intervención en deglución.</p>
</div>
<div class="cv-entry">
